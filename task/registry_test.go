...
func TestGet(t *testing.T) {
	...
	getResult, err := funcRegistry.Get("github.com/deps2code/scheduler/task.(*CallbackMock).CallNoArgs-fm")
...
func TestExists(t *testing.T) {
	...
	found = funcRegistry.Exists("github.com/deps2code/scheduler/task.(*CallbackMock).CallNoArgs-fm")
	if !found {
