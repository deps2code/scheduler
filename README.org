* Go Task Scheduler
[[https://travis-ci.org/deps2code/scheduler][https://img.shields.io/travis/deps2code/scheduler/master.svg?style=flat-square]] [[http://codecov.io/github/deps2code/scheduler?branch=master][http://codecov.io/github/deps2code/scheduler/coverage.svg?branch=master]] [[https://godoc.org/github.com/deps2code/scheduler][https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square]] [[https://github.com/deps2code/scheduler/blob/master/LICENSE.txt][https://img.shields.io/badge/License-MIT-orange.svg?style=flat-square]]
...
* Installation
#+BEGIN_SRC shell
go get github.com/deps2code/scheduler
#+END_SRC
...
The [[https://github.com/deps2code/scheduler/tree/master/_example/][Examples]] folder contains a bunch of code samples you can look into.
